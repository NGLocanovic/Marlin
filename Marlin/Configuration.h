/**
 * Marlin-AM8-SKR-Volcano-BLTouch-A4988_NEW
 * 
...
#define STRING_CONFIG_H_AUTHOR "(NG_Locanovic, AM8-SKR-Volcano-BLTouch-TMC2130)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM8-bugfix v1"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 431.4 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 431.4 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 20, 50 } //{ 400, 400, 8, 50 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 38, 17, 0 }
...
#define X_MIN_POS -22
#define Y_MIN_POS -9 //-25
#define Z_MIN_POS 0
#define X_MAX_POS 226
#define Y_MAX_POS 226 //Y_BED_SIZE
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 108 // ((X_BED_SIZE) / 2)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 108 // ((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
#endif
